...
namespace IntegrationTests
{
    public class IntegrationTestFixture : IDisposable
    {
        ...
        public IntegrationTestFixture(ITestOutputHelper outputHelper)
        {
            ...
            var applicationPath = Path.GetFullPath(Path.Combine(PlatformServices.Default.Application.ApplicationBasePath, "../../../../../src/CoreTemplate.API"));
        ...
        public StringContent JsonContent<T>(T value) => new(JsonConvert.SerializeObject(value), Encoding.UTF8, "application/json");
    }
}
